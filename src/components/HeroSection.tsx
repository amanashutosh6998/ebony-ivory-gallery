    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-20">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-xl lg:text-2xl mb-4 max-w-3xl mx-auto font-light text-gray-400 animate-fade-in" style={{animationDelay: "300ms"}}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-in" style={{animationDelay: "600ms"}}>
            ...
            <Button 
              variant="outline" 
              className="border-white bg-black text-white hover:bg-white hover:text-black px-8 py-6 text-lg"
              asChild
            >
